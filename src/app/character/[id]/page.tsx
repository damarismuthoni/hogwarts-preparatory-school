...
<div className="bg-white py-24 sm:py-32">
    ...
    <div className="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-4xl">
      <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 lg:max-w-none lg:grid-cols-2 lg:gap-y-16">
        <div className="relative pl-16">
          ...
          <dd className="mt-2 text-base leading-7 text-gray-600">{character.house}</dd>
        </div>
        <div className="relative pl-16">
          <dt className="text-base font-semibold leading-7 text-gray-900">
            <div className="absolute left-0 top-0 flex h-10 w-10 items-center justify-center rounded-lg bg-indigo-600">
          ...
          <dd className="mt-2 text-base leading-7 text-gray-600">{character.hairColour}</dd>
        </div>
        <div className="relative pl-16">
          <dt className="text-base font-semibold leading-7 text-gray-900">
            <div className="absolute left-0 top-0 flex h-10 w-10 items-center justify-center rounded-lg bg-indigo-600">
          ...
          <dd className="mt-2 text-base leading-7 text-gray-600">{character.yearOfBirth}</dd>
        </div>
        <div className="relative pl-16">
          <dt className="text-base font-semibold leading-7 text-gray-900">
            <div className="absolute left-0 top-0 flex h-10 w-10 items-center justify-center rounded-lg bg-indigo-600">
          ...
          <dd className="mt-2 text-base leading-7 text-gray-600">{character.wand.wood}</dd>
        </div>
      </dl>
    </div>
  </div>
  ...
  //     className="rounded-md object-contain h-10 w-10 object-center sm:h-full sm:w-full"
  //   />
